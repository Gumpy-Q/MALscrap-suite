...
plot_list=['Production seasons','Production years','Studio production','Studios quantity','TV (New) length','TV (Continuing) length','Score distribution','Score vs viewers','MAL viewers distribution','Source repartition']
